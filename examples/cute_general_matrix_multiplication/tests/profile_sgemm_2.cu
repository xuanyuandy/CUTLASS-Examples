...
//     launch_sgemm_2<float, float, float, float, float>};
// static auto const LAUNCH_GENERAL_MATRIX_MULTIPLICATION_DOUBLE{
//     launch_sgemm_2<double, double, double, double, double>};
static auto const LAUNCH_GENERAL_MATRIX_MULTIPLICATION_HALF_DATA_FLOAT_COMPUTE{
    launch_sgemm_2<cutlass::half_t, cutlass::half_t, cutlass::half_t, float,
                   float>};
static auto const LAUNCH_GENERAL_MATRIX_MULTIPLICATION_HALF_DATA_HALF_COMPUTE{
    launch_sgemm_2<cutlass::half_t, cutlass::half_t, cutlass::half_t,
