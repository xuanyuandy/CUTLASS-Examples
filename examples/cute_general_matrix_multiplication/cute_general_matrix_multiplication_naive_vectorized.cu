                           ...
                           int ldC, cudaStream_t stream)
{
    ...
    constexpr auto NUM_VECTOR_ELEMENTS_A{sizeof(VECTOR_TYPE) / sizeof(TA)};
    ...
    auto copy_A{cute::make_tiled_copy(
        cute::Copy_Atom<cute::UniversalCopy<VECTOR_TYPE>, TA>{},
        thread_layout_A,
        vector_layout_A)}; // Thread layout: (THR_M, THR_K) Value layout:
                           // (NUM_VECTOR_ELEMENTS_A, 1)
    auto const NUM_VECTOR_ELEMENTS_B{sizeof(VECTOR_TYPE) / sizeof(TB)};
    ...
    auto copy_B{cute::make_tiled_copy(
        cute::Copy_Atom<cute::UniversalCopy<VECTOR_TYPE>, TB>{},
        thread_layout_B,
